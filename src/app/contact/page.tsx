  ...
  return (
    <div className="w-full max-w-3xl mx-auto px-4 py-16">
      ...
      >
        ...
        <h1 className="text-4xl font-bold text-white mb-2 relative z-10 tracking-tight">
          Get In Touch
        </h1>
        ...
        <div className="mt-10 flex flex-col sm:flex-row gap-4 items-center justify-center relative z-10 border-t border-white/10 pt-8">
          <p className="text-gray-400 text-sm mb-2 sm:mb-0 sm:mr-4 font-mono">
            Or find me elsewhere:
          </p>
          <a
            href="https://github.com/SanthiSowjanya"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center gap-3 w-full sm:w-auto px-6 py-3 bg-white/5 hover:bg-white/10 border border-white/10 rounded-lg text-white font-medium transition-all group"
          >
            <GithubIcon className="w-5 h-5 group-hover:text-gray-300" />
            <span>GitHub</span>
          </a>
          <a
            href="https://linkedin.com/in/santhi-sowjanya-chokka-708004255"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center gap-3 w-full sm:w-auto px-6 py-3 bg-white/5 hover:bg-white/10 border border-white/10 rounded-lg text-white font-medium transition-all group"
          >
